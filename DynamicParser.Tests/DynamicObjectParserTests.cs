...
{
    public class DynamicObjectParserTests
    {
        private readonly DynamicObjectParser _subject;
        public DynamicObjectParserTests()
        {
            this._subject = new DynamicObjectParser();
        }
        ...
        {
            //arange
            dynamic shouldParsed = new DynamicObjectConfiguration();
            ...
            //assert
            Assert.IsType<DynamicObjectConfiguration>(actualParsed);
